      ...
      <div class="col-lg-10 col-xl-8">
        <div class="card" style="border-radius: 10px;">
          <div class="card-header px-4 py-5">
            ...
            <p class="text-muted mb-0"><a href="orders.php">Back</a></p>
            <a href="invoice.php?invoice=<?php echo $orid ?>" class="btn btn-outline-info mt-4" dowload="invoice.php?invoice=<?php echo $orid ?>">Download Invoice</a>
          </div>
          <div class="card-body p-4">
            ...
            while ($row = mysqli_fetch_assoc($order_items)){
             ...
             <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <p class="small text-muted mb-0">Receipt Voucher : <?php echo $row['order_id']?></p>
            ...
            <div class="card shadow-0 border mb-4">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                    <p class="text-muted mb-0 small">Color: <?php echo $row['colors']  ?></p>
                  </div>
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                ...
                <div class="row d-flex align-items-center">
                  <div class="col-md-2">
                    <p class="text-muted mb-0 small"><a href="delete_items.php?cancel_items=<?php echo $row['item_ref_id'] ?>&order_id=<?php echo $row['order_id'] ?>&price=<?php echo $row['price_num'] ?>&qty=<?php echo $row['quantity'] ?>" class="btn btn-outline-warning"><i class="fas fa-trash"></i></a></p>
                  </div>
                  <div class="col-md-10">
          ...
          ?>
            <div class="d-flex justify-content-between pt-2">
              ...
              <p class="text-muted mb-0"><span class="fw-bold me-4">Total</span> <?php echo $amt_vat." ₹" ?></p>
            </div>

            <div class="d-flex justify-content-between pt-2">
              <p class="text-muted mb-0">Invoice Number : <?php echo $Invoice ?></p>
              <p class="text-muted mb-0"><span class="fw-bold me-4">GST 18%</span> <?php echo "+ ".$gst ?></p>
            </div>

            <div class="d-flex justify-content-between">
              <p class="text-muted mb-0">Total Items : <?php echo $count_item ?></p>
            ...
            <div class="d-flex justify-content-between mb-5">
              <p class="text-muted mb-0"></p>
              <p class="text-muted mb-0"><span class="fw-bold me-4">Total pay</span> <?php echo $order_totals." ₹" ?></p>
            </div>
          </div>
          <div class="card-footer border-0 px-4 py-5" style="background-color: #a8729a; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
            <h5 class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">Total paid: <span class="h2 mb-0 ms-2"><?php echo $order_totals." ₹" ?></span></h5>
          </div>
        </div>
      </div>
    </div>
...
<?php
  ...
  ?>      <div class="d-flex justify-content-center border border-light mt-4 p-5">
              ...
              <img src="images/flipkart.svg" class="img-fluid" alt="">
                ...
                <p class="mt-2 text-center">Not yet order any product/ items? <br><br><a href="index.php" class="btn btn-outline-warning">Continue shopping</a></p> 
  <?php
}
?>
