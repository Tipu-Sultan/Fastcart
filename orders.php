...
<body>
  ...
  ?>
<?php 
$counts = mysqli_query($con,"select * from confirm where user_id='$uid' and status='pending'");
      ...
      <div class="col-lg-10 col-xl-8">
        <div class="card" style="border-radius: 10px;">
          <div class="card-header px-4 py-5">
            ...
            <p class="text-muted mb-0">Total Items : <?php echo $count_order ?></p>
          </div>
          <div class="card-body p-4">
            <?php 
            $order_items = mysqli_query($con,"SELECT * FROM confirm WHERE user_id='$uid' and status='pending' order by id desc");
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                    <p class="text-muted mb-0">Status <br><?php echo $row['status']  ?></p>
                  </div>
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                    <p class="text-muted mb-0 small">Coupon applied<br> <?php echo $row['coupon_value']  ?></p>
                  </div>
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                    <p class="text-muted mb-0 small">Qty<br><?php echo $row['total_item'] ?></p>
                  </div>
                  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                    <p class="text-muted mb-0 small">GT <br><?php echo $row['price']." ₹" ?></p>
                  </div>
                </div>
                <hr class="mb-4" style="background-color: #e0e0e0; opacity: 1;">
                <div class="row d-flex align-items-center">
                  <div class="col-md-2">
                    <p class="text-muted mb-0 small"><a href="?cancel_order=<?php echo $row['order_id'] ?>">Cancel Order</a></p>
          ...
          ?>
            <div class="d-flex justify-content-between pt-2">
              ...
              <p class="text-muted mb-0"><span class="fw-bold me-4">Total</span> <?php echo $total_pay_amount." ₹" ?></p>
            </div>
