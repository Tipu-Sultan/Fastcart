...
?></em></h4>
    ...
    include 'themancode.php';
        ...
        $sql =  " SELECT id,name,image,price,size,type,colors,brief_info, 'items' FROM items where name like  '%$query%' or price like '%$query%' or type like  '%$query%'   or colors like  '%$query%' or brief_info like  '%$query%'";
              ...
              <div class="card">
                ...
                >
                  <img
                    ...
                    height="200"
                  />
                  <a href="product_details.php?pid='.$top['id'].'&type='.$top['type'].'">
                    <div class="mask">
